        ...
        <div class="list-banchay">
            <div class="list-banchay-img" id="topbanchay" runat="server">
                ...
                <div class="all">
                    ...
                    <button class="btn-them" id="themgiohang1">Thêm vào giỏ hàng</button>
                </div>
                <div class="all">
                    ...
                    <button class="btn-them" id="themgiohang2">Thêm vào giỏ hàng</button>
                </div>
                <div class="all">
                    ...
                    <button class="btn-them" id="themgiohang3">Thêm vào giỏ hàng</button>
                </div>
                <div class="all">
